...
See the [Terms of Service](https://ole-luk-oie.com/primes-tos/) for details.*
...
The plugin checks projects for unsupported usage and will warn or block publishing if such APIs are detected.
...
This plugin is a convenience tool.  
Everything it does can also be done manually via the Primes API - the plugin simply makes the workflow faster and more pleasant.
